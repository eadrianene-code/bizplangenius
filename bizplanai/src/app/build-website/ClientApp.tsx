...
import { WEBSITE_TYPES, COLOR_SCHEMES } from './data';
...
const QUICK_EDITS = [
  { label: 'Add payment links', instruction: 'I want to add payment links to my pricing buttons and CTA buttons. Ask me for my payment URL (Stripe, PayPal, or other) and wire it into all Buy/Order/Get Started buttons. Open links in new tab.', icon: '💳' },
