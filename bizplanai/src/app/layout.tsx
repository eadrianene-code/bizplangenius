...
export const metadata: Metadata = {
  ...
  description: 'Describe your business idea once and AI builds everything you need to launch: a business plan with real competitor data, a website that takes payments, brand identity, pitch deck, social media content, legal pages, and ad copy. Start free or get the full kit for $397.',
