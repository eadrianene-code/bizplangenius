...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/api/og?title=Save+%24182+With+Bundles&subtitle=Spy+%2B+Plan+from+%24197.+Add+Website+%2B+Pitch+for+%24297.+Full+Business+Kit+%24447.&badge=Bundles',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['/api/og?title=Save+%24182+With+Bundles&subtitle=Spy+%2B+Plan+from+%24197.+Add+Website+%2B+Pitch+for+%24297.+Full+Business+Kit+%24447.&badge=Bundles'],
  },
};
