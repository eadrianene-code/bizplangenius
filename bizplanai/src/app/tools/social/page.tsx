...
const ONE_CLICK_TOPICS = [
  ...
  { label: 'Promote Full Business Kit', icon: '💼', input: 'BizPlan Genius lets you walk in with just an idea and leave with an entire business: plan, website, brand, pitch deck, legal pages, social content, and ad copy. All from one description. Full kit $349 at bizplangenius.com/bundles', inputType: 'product' as const },
