...
function buildPDF(plan: BusinessPlan, businessName: string) {
  ...
  content.push(
    ...
    { text: `Last updated: ${date}`, fontSize: 11, color: TEXT_MUTED, alignment: 'center', margin: [0, 6, 0, 0] },
    { text: 'Data sourced live via Google Search grounding', fontSize: 8, color: TEXT_MUTED, alignment: 'center', italics: true, margin: [0, 2, 0, 0] },
    { text: '\n\n\n\n\n\n\n\n\n\n\n\n', fontSize: 10 },
  ...
  content.push({
    ...
    stack: [
      ...
      { canvas: [{ type: 'line', x1: 0, y1: 0, x2: 515, y2: 0, lineWidth: 0.5, lineColor: LINE }] },
      { text: `Generated by BizPlan Genius, last updated ${date}`, fontSize: 8, color: TEXT_MUTED, alignment: 'center', margin: [0, 10, 0, 2] },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12 pb-28 sm:pb-12">
        ...
        {/* Review Request CTA */}
        <div className="bg-gradient-to-br from-yellow-50 to-amber-50 border border-amber-200 rounded-2xl p-6 sm:p-8 text-center print-hide">
          <div className="text-3xl mb-2">⭐⭐⭐⭐⭐</div>
          <h3 className="text-xl font-bold text-gray-900 mb-2">Did this plan help you?</h3>
          <p className="text-gray-700 mb-4 max-w-xl mx-auto text-sm">
            We are a tiny bootstrapped team. A 30-second review on G2 or Trustpilot helps more founders find us
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="inline-block px-5 py-2.5 bg-amber-500 text-white font-semibold rounded-lg hover:bg-amber-600 transition text-sm"
            >
              Leave a G2 Review
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-5 py-2.5 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition text-sm"
            >
              Leave a Trustpilot Review
            </a>
            <a
              href="mailto:support@bizplangenius.com?subject=Feedback%20on%20my%20business%20plan"
              className="inline-block px-5 py-2.5 border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:border-gray-400 transition text-sm"
            >
              Email Feedback
            </a>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-4 print-hide">
          <div className="mt-8 p-6 sm:p-8 rounded-2xl border border-brand-200 bg-gradient-to-br from-brand-50 to-white shadow-sm">
            <div className="flex items-start gap-4">
              <div className="hidden sm:flex w-12 h-12 rounded-full bg-brand-100 text-brand-700 items-center justify-center flex-shrink-0 text-xl">
                🎯
              </div>
        ...
        <div className="text-center py-8 text-xs text-gray-400 print-hide">
          ...
          <a href={`/dashboard?session_id=${currentSessionId}`} className="inline-block mt-3 text-brand-600 hover:text-brand-700 underline text-sm">
