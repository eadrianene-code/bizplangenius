...
/* ---- Color palette â professional navy/blue theme ---- */
...
function buildPDF(plan: BusinessPlan, businessName: string) {
  ...
  /* TOC removed â pdfmake cannot generate real page numbers,
  ...
  /* Market Size and Growth Rate as separate callout boxes â twoCol creates
  ...
  if (plan.marketingStrategy?.channels?.length) {
    ...
    /* Marketing Channels table can be tall (5-6 rows), so don't make the whole
       thing unbreakable â just keep heading with first rows via dontBreakRows.
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-gray-500 mb-6">
            Don&apos;t worry â your payment is safe. Please contact us and we&apos;ll generate your plan right away.
          </p>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12 pb-28 sm:pb-12">
        ...
        <div className="text-center py-8 text-xs text-gray-400 print-hide">
          <p>Generated by BizPlan Genius â bizplangenius.com</p>
